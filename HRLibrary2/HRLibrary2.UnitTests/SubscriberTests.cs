...
namespace HRLibrary.UnitTests_
{
    ...
    public class Tests
    {
        ...
        public void CompareToTest()
        {
            ...
            Assert.That(alisa.CompareTo(alexander), Is.LessThan(0));
            Assert.That(alexander.CompareTo(mihail), Is.GreaterThan(0));
            Assert.That(jaroslav.CompareTo(maria), Is.LessThan(0));
            Assert.That(maria.CompareTo(maria), Is.EqualTo(0));
        }
    }
}
